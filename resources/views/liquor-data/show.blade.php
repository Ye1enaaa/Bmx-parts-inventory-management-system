...
<div class="main-liquor-data-show">
        ...
        <div style="position: fixed; bottom: 0; left: 50%; transform: translateX(-50%);" class="w-screen">
          <div class="box bg-custom-color p-1 ml-6 mr-6">
            <div class="flex items-center justify-end">
              <div class="mr-96 py-2 px-6 text-black text-xl font-bold h-full">
                Total stock on hand: {{$totalstocks}}
              </div>
              ...
              <a href="#" id="download-inventory-btn" class="rounded-lg mr-8 justify-center py-1 px-6 text-xl font-bold bg-black hover:bg-blue-400" onclick="downloadInventory()" style="margin-left: 20px;">
  ...
  <div class="px-10 mx-auto p-11 rounded-2xl shadow-md hidden" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); border: 1px solid black; padding: 10px; display: none; background-color: white; width: 50%; border-radius: 10px; box-shadow: 0 4px 6px -1px black; background-color: white;" id="edit-form">
